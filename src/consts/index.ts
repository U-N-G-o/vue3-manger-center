...
class Consts {
  public static MutationKey = class {
    ...
    public static SET_TODOLIST = ModuleName.TODO + '/SET_TODOLIST'
    public static SET_TODO_STATUS = ModuleName.TODO + '/SET_TODO_STATUS'
    public static DEL_TODO = ModuleName.TODO + '/DEL_TODO'
    public static ADD_TODO = ModuleName.TODO + '/ADD_TODO'
  }

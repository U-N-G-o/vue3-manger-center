      ...
      <div class="inputs">
        <el-form ref="loginForm" :model="loginFormData" :rules="loginRules" class="input-form">
          <el-form-item prop="username">
            <el-input v-model="loginFormData.username" prefix-icon="el-icon-user" placeholder="用户名：admin"
              @focus="isInputFocus = true" @blur="isInputFocus = false" @keyup.enter="onLogin" />
          </el-form-item>
          <el-form-item prop="password">
            <el-input v-model="loginFormData.password" prefix-icon="el-icon-lock" placeholder="密码：admin" show-password
              @focus="isInputFocus = true" @blur="isInputFocus = false" @keyup.enter="onLogin" />
          </el-form-item>
          <el-row :gutter="16">
            <el-col :span="17">
              <el-form-item prop="checkcode">
                <el-input v-model="loginFormData.checkcode" prefix-icon="el-icon-key" placeholder="请输入验证码"
                  class="input__checkcode" @focus="isInputFocus = true" @blur="isInputFocus = false"
                  @keyup.enter="onLogin" />
              </el-form-item>
            </el-col>
            <el-col :span="7">
...
<style lang="scss">
  .rain {
    position: relative;
    height: 100%;
    background: linear-gradient(180deg, rgba(236, 253, 223, 0.69) 0%, rgba(0, 188, 212, 1) 50%, rgba(54, 43, 157, 1) 100%);
